  ...
  async sendMessage (prompt, conversation = {}, use, e) {
    ...
    if (use === 'bing') {
      ...
      if (Config.enableNai3PluginToPaint || Config.enableApPluginToPaint) {
        system += 'If I ask you to generate picture prompt or painting, you need to reply with no more than 200 keywords in English suitable for Stable Difussion to generate picture. The returned message is in JSON format, with a structure of ```json{"Tools": "NovelAi", "tags": "Your tags"}```.'
