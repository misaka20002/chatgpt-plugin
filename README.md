...
- 2024年6月1日，新增对话使用gemini的图片识图，详细在锅巴中设置
- ~~2024年7月7日新增更多Fish-VITS2的支持（感谢fish.audio提供的api支持！）~~
- 2024年7月8日，Ai智能调用画图插件 `prompt模式绘图`
- 2024年7月9日，对话白名单的逻辑改为使用喵崽配置管理的白名单群逻辑；
- 2024年8月22日，新增 `分多次回复`
- 2024年10月11日，tts接入FISH API
- ~~2024年10月21日，tts接入海螺~~
...
- 2026年1月1日，Gemini模式、OpenAI API模式支持多工具并行调用[^1]
...
- 2026年6月1日，智能模式中增加 `必应图片搜索工具` `思维导图工具` `用户画像工具` `Prompt Gallery`[^2] `公式及作图` ；新增指令 `#gpt发语音`
...
- 戳一戳功能
  ...
  - 最完善的戳一戳功能，整合数十种api
  - **反戳** 功能需要适配器支持Napcat语法，推荐使用 [呆毛版的Trss-Onebot适配器](https://github.com/AIGC-Yunzai/TRSS-Yunzai-NapC)
