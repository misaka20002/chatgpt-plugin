...
const defaultConfig = {
  ...
  paimon_chou_apis: {
    ...
    wyyrp: "https://api.xingzhige.com/API/NetEase_CloudMusic_hotReview/",
    mingyanjingju: "https://oiapi.net/API/Saying",
    gushici: "https://oiapi.net/API/Sentences",
    hefeng: "http://113.31.103.19:8848",
    kfc: "https://oiapi.net/API/KFC/",
    aword: "https://oiapi.net/API/AWord",
    sick: "https://oiapi.net/API/SickL/",
    dailyEnglish: "https://oiapi.net/API/Daily"
  },

  // 戳一戳图片地址配置
  paimon_chou_image_urls: {
    ecy: [
  ...
  paimon_chou_formats: {
    ...
    mingyanjingju: "“咳咳~”{name}开始模仿伟人讲话：",
    gushici: "“咳咳~”{name}开始模仿古人讲话：",
    hefeng: "“咳咳~”{name}开始模仿女仆讲话：",
    aword: "“咳咳~”{name}开始模仿别人讲话：",
    sick: "“咳咳~”{name}开始说胡话：",
    kfc: "“咳咳~”{name}：",
    dailyEnglish: "来和{name}一起学英语吧，老师读一遍，{name}读一遍>_<",
    reward_nai3: "喵>_< 谢谢你和{name}玩，{name}偷偷送给你{num}次绘画次数哦~",
    counter_poke1: "{name}也要戳戳你>_<",
    counter_poke2: "你刚刚是不是戳{name}了?{name}要戳回去！",
    counter_poke3: "让你戳{name}，哼！！！",
    master_poke1: "主人连你也欺负{name}，呜呜呜~",
    master_poke2: "主人有什么事吗？喵~",
    mute_no_perm1: "呜呜呜你欺负{name}QAQ",
    mute_no_perm2: "主人有坏淫欺负{name}QAQ",
    mute_no_perm3: "气死{name}了不要戳了！",
    mute_no_perm4: "{text}...呜呜，如果{name}有管理员权限就禁言你1分钟QAQ",
    mute_perm1: "是不是要{name}揍揍你才开心呀！",
    mute_perm2: "让你面壁思过{minutes}分钟，哼😤～",
    mute_perm3: "要怎么样才能让你不戳{name}啊！",
    mute_perm4: "干嘛戳{name}，{name}要惩罚你！",
    mute_fallback1: "呜呜，有什么开心不开心的都冲{name}来吧QAQ",
    mute_fallback2: "请戳{name}吧，{name}...{name}什么都愿意做QAQ",
    mute_fallback3: "呜呜呜，{name}愿意为你做任何事情",
    img_reply1: "喵>_< {name}有点开心，这是{name}私藏的画片哦",
    img_reply2: "这是{name}今天找到的画片哦，主人喜欢吗？",
    img_reply3: "主人，快看快看{name}发现了什么？",
    img_reply4: "主人主人，{name}今天捡到了一张奇怪的明信片，拿给你看看",
    img_reply5: "呜呜，{name}给你一张涩涩的画片，不要再戳戳人家了",
  },

  // 戳一戳文字子类型权重配置 (发送文字时按权重随机选一种)
  paimon_chou_text_weights: {
    paimon_msg: 11,
    kaomoji: 2,
    love_speech: 3,
    kfc: 2,
