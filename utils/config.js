...
const defaultConfig = {
  ...
  enableApPluginToPaint: false,
  enableSiliconflowPluginToPaint: false,
  nai3PluginToPaintPrefix: "toddler, artist:ciloranko, [artist:tianliang duohe fangdongye], [artist:sho_(sho_lwlw)], [artist:baku-p], [artist:tsubasa_tsubasa], ",
  nai3PluginCharactersList: '{"nahida":"{{nahida_(genshin_impact)}}","klee":"{{klee_(genshin_impact)}}","paimon":"{{paimon_(genshin_impact)}}","bailu":"{{bailu_(honkai:_star_rail)}}","clara":"{{clara_(honkai:_star_rail)}}","last(_|\s)order|misaka":"{{last_order(Toaru_Majutsu_no_Index)}}","sayu":"{{sayu_(genshin_impact)}}","diona":"{{diona_(genshin_impact)}}","yaoyao":"{{yaoyao_(genshin_impact)}}","qiqi":"{{qiqi_(genshin_impact)}}","furina":"{{furina_(genshin_impact)}}","Mahiro":"{{Oyama_Mahiro(Onichanhaoshimai)}}","arona":"{{arona_(blue_archive)}}","sora":"{{sora_(blue_archive)}}","kokona":"{{kokona_(blue_archive)}}","hoshino":"{{hoshino_(blue_archive)}}","Koharu":"{{Shimoe_Koharu_(Blue archive)}}","Gura":"{{Gawr_Gura_(Hololive)}}","suzuran":"{{suzuran_(arknights)}}","Anya":"{{Anya_Forger(SPY×FAMILY), light pink hair}}","Azusa":"{{nakano_Azusa(K-ON)}}"}',
