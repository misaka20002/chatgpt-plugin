        ...
        */
        ...
        try {
            ...
            try {
                ...
                logger.error(`生成语音api发生错误，请检查是否配置了正确的api。准备重试第一次，当前response.status为`, response.status)
            }
            //重试10次如果message!="Success"
            for (post_times = 0; post_times < 4; post_times++) {
                ...
                try {
                    ...
                    logger.error(`生成语音api发生错误，请检查是否配置了正确的api。正在重试第${post_times + 1}次，当前response.status为`, response.status)
                }
            ...
            */
            ...
            logger.error(`生成语音api发生错误，请检查是否配置了正确的api。共重试${post_times + 1}次，当前response.status为`, response.status)
